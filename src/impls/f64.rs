...
// Reversed mixed-type operations: `f64 op Algebraic<f64>`

impl Add<Algebraic<Self>> for f64 {
...
impl Sub<Algebraic<Self>> for f64 {
    type Output = Algebraic<Self>;
...
impl Mul<Algebraic<Self>> for f64 {
    type Output = Algebraic<Self>;
...
impl Div<Algebraic<Self>> for f64 {
    type Output = Algebraic<Self>;
...
impl Rem<Algebraic<Self>> for f64 {
    type Output = Algebraic<Self>;
